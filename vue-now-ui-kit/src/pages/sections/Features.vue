  ...
  <div id="features" class="cd-section">
        ...
        <div class="row">
          <div class="col-md-8 ml-auto mr-auto">
            ...
            <h4 class="description">
              Insight to help you create, connect, and convert. Understand Your Audience's Interests, Influence,
              Interactions, and Intent. Discover emerging topics and influencers to reach new audiences.
            </h4>
          </div>
        </div>
        <div class="row">
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-8 mr-auto ml-auto">
            ...
            <h4 class="description">
              Trello’s boards, lists, and cards enable you to organize and prioritize your projects in a fun, flexible
              and rewarding way.
            </h4>
          </div>
        </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-8 ml-auto mr-auto">
            ...
            <h4 class="description">
              The CloudCheckr Cloud Management Platform (CMP) provides full visibility and control to reduce costs,
              improve cybersecurity posture, and automate critical tasks.
            </h4>
          </div>
        </div>
        <div class="row">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-8 ml-auto mr-auto text-center">
            ...
            <h4 class="description">
              Havenly is a convenient, personal and affordable way to redecorate your home room by room. Collaborate
              with our professional interior designers on our online platform.
            </h4>
          </div>
        </div>
        <div class="row">
          ...
          <div class="col-md-5">
            ...
            <div class="info info-horizontal">
              ...
              <div class="description">
                ...
                <p>
                  The moment you use Now UI Kit, you know you’ve never felt anything like it. With a single use lets you
            ...
            <div class="info info-horizontal">
              ...
              <div class="description">
                ...
                <p>
                  ...
                  paragraph describing a feature.
                </p>
              </div>
            </div>
            <div class="info info-horizontal">
          ...
          <div class="col-md-4">
            <div class="info info-horizontal">
              ...
              <div class="description">
                ...
                <p>
                  The moment you use Now UI Kit, you know you’ve never felt anything like it. With a single use, this
            ...
            <div class="col-sm-12">
              ...
              <div class="info info-horizontal">
                ...
                <div class="description">
                  ...
                  <p class="description">
                    The moment you use Now UI Kit, you know you’ve never felt anything like it. With a single use, this
                    powerful UI Kit lets you do more than ever before.
                  </p>
                </div>
              </div>
            </div>
    ...
    <div class="features-8 section-image" style="background-image: url('img/bg30.jpg')">
      <div class="col-md-8 ml-auto mr-auto text-center">
        <h2 class="title">Working is a pleasure</h2>
        <h4 class="description">
          Woodpecker.co is a follow-up automation SaaS founded in 2015. We’re an international team of 17, speaking 4
          languages. Our mission is to enable all B2B companies to connect with their Ideal Customers.
        </h4>
      </div>
      <div class="container">
        <div class="row">
